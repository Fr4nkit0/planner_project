export function reporteHtml(reporte){
    ...
    return `
        ...
        <div class="d-flex justify-content-between align-items-center titulo_reporte">
            ...
            <div class="icono">
                <a href="#" class="me-2 btn-editar-reporte" data-id="${reporte.id}" data-tipo="editar-reporte" data-nombre="${ reporte.titulo}" data-descripcion="${reporte.descripcion}"><img src="${ lapizUrl }" alt="Editar" width="20"></a>
                <a href="#" class="btn-eliminar-reporte" data-id="${reporte.id}" data-tipo="eliminar-reporte" data-nombre="${reporte.titulo}"><img src="${ eliminarUrl }" alt="Eliminar" width="20"></a>
            </div>
        </div>
...
export function eliminarReporteFormularioHtml(reporteId, titulo) {
    return `
        <p class="text-center">¿Estás seguro de eliminar el reporte ?</p>
